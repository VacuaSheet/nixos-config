...
programs.zsh = {
  ...
  enable = true; 
	...
	ani-tupi = "nix-shell --pure -p uv mpv fzf curl bash --run 'export PATH=/run/current-system/sw/bin:/usr/bin:/bin:$PATH; uv run --project $HOME/ani-tupi $HOME/ani-tupi/main.py'";
