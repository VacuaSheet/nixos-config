    ...
    shellAliases = {
     nos = "nh os switch /home/_-_-yakov_-_-/nixos-config";
      ...
      gp = "git -C /home/_-_-yakov_-_-/nixos-config push origin main"; # Git push
       ...
       # Servidor Minecraft
       squidservers = "bwrap --ro-bind /nix /nix --ro-bind /etc /etc --bind /home/_-_-yakov_-_-/Apps /home/_-_-yakov_-_- --dev /dev --proc /proc --tmpfs /tmp --share-net /run/current-system/sw/bin/appimage-run /home/_-_-yakov_-_-/Apps/squidservers-latest.appimage";
         };  
