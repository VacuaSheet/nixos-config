...
programs.zsh = {
  ...
  enable = true; 
	...
	ani-tupi = "nix shell nixpkgs#uv nixpkgs#mpv nixpkgs#fzf nixpkgs#curl nixpkgs#yt-dlp nixpkgs#webkitgtk_4_1 -c sh -c 'env WEBKIT_DISABLE_COMPOSITING_MODE=1 STEAM_APPID=\"\" SB_APPID=\"\" PLAYER=mpv uv run --script https://githubusercontent.com'";
