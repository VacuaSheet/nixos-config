...
let
  # Criamos o atalho do menu
  squidDesktopItem = pkgs.makeDesktopItem {
    name = "squidservers";
    desktopName = "SquidServers";
    exec = "squidservers"; # Nome do binário/script que criamos abaixo
    icon = "/home/_-_-yakov_-_-/Apps/SquidServersData/squidservers.png";
    comment = "Gerenciador de Servidores Minecraft";
    categories = [ "Game" "Network" ];
  };

  # Criamos o script que roda o AppImage via bwrap
  squidScript = pkgs.writeShellScriptBin "squidservers" ''
